...
Summary: Type annotations for boto3.S3 1.43.66 service, generated by mypy-boto3-builder
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/mypy-boto3-s3-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mypy-boto3-s3-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add mypy-boto3-s3
# for installing globally
pixi global install mypy-boto3-s3
```
...
It is possible to list all of the versions of `mypy-boto3-s3` available on your platform:
...
```
pixi search mypy-boto3-s3 --channel conda-forge
```
